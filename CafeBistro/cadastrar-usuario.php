...
<main>
    ...
    <section class="container-form">
        <form method="post" action="processar-cadastro.php">
            ...
            <input type="password" id="confirmar senha" name="confirmar senha" placeholder="Digite uma senha" required>
            <?php
            if(isset($_GET["erro"])){//echo "erro! senha e confirmar senha não são iguais";?>      
